...
# @Last Modified time: 2021-10-01 14:57:44
...
def main(src_path):
    ...
    df_train, df_test = train_test_split(df, stratify=df.y, test_size=0.1, random_state=15082021)

    # Create and fit model
    model = fit_logistic_regression(df_train[['x1','x2']], df_train.y)

    # Evaluate model
    evaluate_logistic_regression(model, df_test[['x1','x2']], df_test.y)
