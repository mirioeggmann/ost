...
-- Testat 4: 
-- Aufgabe 2 -> bereits enthalten in person table etc.

-- Aufgabe 3 Schema-Evolution
-- 3.1 ENUM einbauen
CREATE TYPE ausbildungs_typ AS ENUM ('zwingend','optional');

ALTER TABLE ausbildung
ADD COLUMN ausbildungs_typ ausbildungs_typ;

-- 3.2 BOOLEAN einbauen
ALTER TABLE person
ADD COLUMN active BOOLEAN;

-- 3.4 DATETIME einbauen
ALTER TABLE person
ADD COLUMN deactivated_at TIMESTAMP;

-- Aufgabe 4 Indexe
CREATE INDEX idx_mail ON person(lower(mail));
