...
def train_network(
    ...
    current_loss = network.loss_function(
        validation_data, validation_labels, w, b, Wt, bt
    )
    ...
    while True:
        ...
        w, b, Wt, bt = network.update_weights(
            batch_data, batch_labels, w, b, Wt, bt, learning_rate
        )
    ...
    predictions, performance = network.evaluate_prediction(
        test_data, test_labels, w, b, Wt, bt
    )
